                ...
                <div class="mt-6 mb-2">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                            {{ $shortUrl }}
                            <button type="button" onclick="copyText(`{{ $longUrl }}`)" class="ml-4 inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-tight">
